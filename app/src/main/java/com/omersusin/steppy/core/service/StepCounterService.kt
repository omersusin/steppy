...
import com.omersusin.steppy.MainActivity
...
class StepCounterService : LifecycleService(), SensorEventListener {
    ...
    override fun onCreate() {
        ...
        val application = application as SteppyApplication
        val settingsRepository = SettingsRepositoryImpl(application.settingsStore)
        val dayRepository = DayRepositoryImpl(application.steppyDatabase.dayDao)
